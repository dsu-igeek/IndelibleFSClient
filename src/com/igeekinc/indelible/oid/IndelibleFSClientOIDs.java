...
public class IndelibleFSClientOIDs
{
	public static void initMappings()
	{
		CASCollectionID.initMapping();
		CASSegmentID.initMapping();
		CASStoreID.initMapping();
		DataMoverSessionID.initMapping();
		EntityID.initMapping();
		IndelibleFSObjectID.initMapping();
		NetworkDataDescriptorID.initMapping();
