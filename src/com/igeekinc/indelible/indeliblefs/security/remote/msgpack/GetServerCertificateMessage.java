...
@Message
public class GetServerCertificateMessage extends CommandMessage
{
	public GetServerCertificateMessage()
	{
	}
	...
	{
		return EntityAuthenticationServerFirehoseClient.EntityAuthenticationCommand.kGetServerCertificate.getCommandNum();
	}
}
