...
public class AsyncStoreSegmentCommandBlock extends RemoteAsyncCommandBlock
{
	...
	public AsyncStoreSegmentCommandBlock(CASIDDataDescriptor sourceDescriptor)
	{
	...
	public void executeAsync(AsyncCompletion completionHandler)
			throws Exception
	{
		connection.storeSegmentAsync(sourceDescriptor, completionHandler, null);
	}
