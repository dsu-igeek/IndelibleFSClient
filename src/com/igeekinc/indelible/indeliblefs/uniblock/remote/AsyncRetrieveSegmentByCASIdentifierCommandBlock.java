...
public class AsyncRetrieveSegmentByCASIdentifierCommandBlock extends RemoteAsyncCommandBlock
{
	private static final long	serialVersionUID	= 4849033811852311417L;
	private transient CASCollectionConnection connection;
	private CASIdentifier segmentID;
	
	public AsyncRetrieveSegmentByCASIdentifierCommandBlock(CASIdentifier segmentID)
	{
	...
	public void executeAsync(AsyncCompletion completionHandler)
			throws Exception
	{
		connection.retrieveSegmentAsync(segmentID, completionHandler, null);
	}
