...
public class CollectionCreatedEvent extends CASServerEvent
{
	private static final long	serialVersionUID	= -5547872950616496909L;
	private CASCollectionID collectionID;
	
	public CollectionCreatedEvent(EntityID source, long eventID, long timestamp, CASCollectionID collectionID)
	{
		super(source, eventID, timestamp);
		this.collectionID = collectionID;
	}
	
	public CollectionCreatedEvent(EntityID source, CASCollectionID collectionID)
	{
		super(source);
		this.collectionID = collectionID;
	}
	...
	{
		return CASServerEventType.kCollectionCreated;
	}
}
