...
public class SegmentExists extends IndelibleFSException
{
	private static final long	serialVersionUID	= -8078794804469401342L;
	private ObjectID segmentID;
	public SegmentExists(ObjectID segmentID)
	{
	...
	{
		return "Segment "+getSegmentID()+" exists";
	}
}
