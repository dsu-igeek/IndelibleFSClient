...
public class CASServerEventIteratorProxy implements IndelibleEventIterator, AsyncCompletion<NextCASServerEventListItemsReply, Void>
{
	...
	public CASServerEventIteratorProxy(CASServerFirehoseClient client, CASServerConnectionProxy serverConnection, IndelibleEventIteratorHandle handle, IndelibleEvent [] initial, boolean hasMore)
	{
		this.client = client;
		...
		if (nextCached >= cached.length)
		{
			...
			try
			{
				if (serverConnection != null)
					client.nextCASServerEventListItemAsync(serverConnection, handle, this, null);
			} catch (IOException e)
			{
	...
	public void close()
	{
		serverConnection.proxyFinalized(this);
	}
	...
	@Override
	public synchronized void completed(NextCASServerEventListItemsReply result, Void attachment)
	{
