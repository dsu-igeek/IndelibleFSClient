...
public class IndelibleVersionIteratorProxy implements IndelibleVersionIterator, AsyncCompletion<NextVersionListItemsReply, Void>
{
	...
	private CASCollectionConnectionProxy connection;
	...
	public IndelibleVersionIteratorProxy(CASServerFirehoseClient client, CASCollectionConnectionProxy connection, IndelibleVersionIteratorHandle handle, IndelibleVersion [] initial, boolean hasMore)
	{
		this.client = client;
