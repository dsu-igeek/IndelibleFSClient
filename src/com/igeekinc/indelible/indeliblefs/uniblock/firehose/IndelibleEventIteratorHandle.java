...
public class IndelibleEventIteratorHandle implements MessagePackable
{
	private long connectionHandle;

	public IndelibleEventIteratorHandle()
	{
		
	}
	
	public IndelibleEventIteratorHandle(long connectionHandle)
	{
	...
	public boolean equals(Object obj)
	{
		...
		if (getClass() != obj.getClass())
			return false;
		IndelibleEventIteratorHandle other = (IndelibleEventIteratorHandle) obj;
