...
@Message
public class GetMetaDataForReplicationMessage<A> extends CASCollectionConnectionCommand<CASIDDataDescriptor, A, NetworkDataDescriptorMsgPack>
{
	public GetMetaDataForReplicationMessage()
	{
		// for message pack
	}

	public GetMetaDataForReplicationMessage(CASServerFirehoseClient client,
	...
	{
		return server.getMetaDataForReplication(clientInfo, getConnectionHandle(), getCollectionConnectionHandle());
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kGetMetaDataForReplication;
	}
}
