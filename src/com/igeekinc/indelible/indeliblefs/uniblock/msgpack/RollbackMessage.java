...
@Message
public class RollbackMessage<A> extends CASServerConnectionCommand<Void, A, Void>
{
	...
	public RollbackMessage(CASServerFirehoseClient client, CASServerConnectionProxy connection,
	...
	{
		return server.rollback(clientInfo, getConnectionHandle());
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kRollback;
	}
