...
@Message
public class RollbackCollectionTransactionMessage<A> extends CASCollectionConnectionCommand<Void, A, Void>
{
	public RollbackCollectionTransactionMessage()
	{
		// for message pack
	}

	public RollbackCollectionTransactionMessage(CASServerFirehoseClient client,
	...
	{
		return server.rollbackCollectionTransaction(clientInfo, getConnectionHandle(), getCollectionConnectionHandle());
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kRollbackCollectionTransaction;
	}
}
