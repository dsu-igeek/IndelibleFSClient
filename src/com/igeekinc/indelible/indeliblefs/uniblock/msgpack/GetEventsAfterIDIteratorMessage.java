...
@Message
public class GetEventsAfterIDIteratorMessage<A> extends CASServerConnectionCommand<IndelibleEventIterator, A, CASServerEventIteratorReply>
{
	long startingID;
	
	public GetEventsAfterIDIteratorMessage()
	{
		// for message pack
	}

	public GetEventsAfterIDIteratorMessage(CASServerFirehoseClient client, CASServerConnectionProxy connection,
			long startingID,
	...
	{
		return server.eventsAfterIDIterator(clientInfo, getConnectionHandle(), startingID);
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kGetEventsAfterIDIterator;
	}
