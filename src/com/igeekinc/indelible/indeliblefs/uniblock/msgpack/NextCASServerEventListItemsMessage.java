...
@Message
public class NextCASServerEventListItemsMessage<A>
		extends
		CASServerConnectionCommand<NextCASServerEventListItemsReply, A, NextCASServerEventListItemsReply>
{
	IndelibleEventIteratorHandle handle;
	public NextCASServerEventListItemsMessage()
	{
		// for message pack
	}
	...
	public NextCASServerEventListItemsMessage(
			...
			CASServerConnectionProxy connection,
			IndelibleEventIteratorHandle handle,
			AsyncCompletion<NextCASServerEventListItemsReply, A> callerCompletionHandler,
			A attachment)
	{
	...
	@Override
	protected NextCASServerEventListItemsReply getValueFromResult(
			NextCASServerEventListItemsReply result)
	{
		return result;
	}

	@Override
	public Class<NextCASServerEventListItemsReply> getResultClass()
	{
		return NextCASServerEventListItemsReply.class;
	}
	...
	{
		return server.nextEventListItems(clientInfo, getConnectionHandle(), handle);
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kNextCASServerEventListItems;
	}
}
