...
@Message
public class SetupReverseMoverConnectionMessage<A> extends CASServerConnectionCommand<Void, A, Void>
{
	public ObjectIDMsgPack securityServerID;
	public String connectToAddress;
	public int connectToPort;
	
	public SetupReverseMoverConnectionMessage()
	{
		// for message pack
	}

	public SetupReverseMoverConnectionMessage(CASServerFirehoseClient client, CASServerConnectionProxy connection,
			EntityID securityServerID, InetAddress connectToAddress, int connectToPort,
			AsyncCompletion<Void, A> callerCompletionHandler, A attachment)
	{
		...
		this.connectToAddress = connectToAddress.toString();
	...
	{
		InetAddress connectToAddress = InetAddress.getByName(this.connectToAddress);
		return server.setupReverseMoverConnection(clientInfo, getConnection(), (EntityID)securityServerID.getObjectID(),
				connectToAddress, connectToPort);
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kSetupReverseMoverConnection;
	}
