...
@Message
public class StartCollectionReplicatedTransactionMessage<A> extends CASCollectionConnectionCommand<Void, A, Void>
{
	public CASCollectionEventMsgPack transactionEvent;
	public StartCollectionReplicatedTransactionMessage()
	{
		// for message pack
	}

	public StartCollectionReplicatedTransactionMessage(CASServerFirehoseClient client, CASCollectionConnectionProxy connection,
			TransactionCommittedEvent transactionEvent, AsyncCompletion<Void, A> completionHandler, A attachment)
	{
		super(client, connection, completionHandler, attachment);
		this.transactionEvent = new CASCollectionEventMsgPack(transactionEvent);
	}
	...
	{
		return server.startCollectionReplicatedTransaction(clientInfo, getConnectionHandle(), getCollectionConnectionHandle(),
				(TransactionCommittedEvent) transactionEvent.getEvent());
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kStartCollectionReplicatedTransaction;
	}
}
