...
@Message
public class StartListeningForCollectionMessage<A> extends CASCollectionConnectionCommand<Void, A, Void>
{
	public StartListeningForCollectionMessage()
	{
		// for message pack
	}

	public StartListeningForCollectionMessage(CASServerFirehoseClient client,
	...
	{
		return server.startListeningForCollection(clientInfo, getConnectionHandle(), getCollectionConnectionHandle());
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kStartListeningForCollection;
	}
}
