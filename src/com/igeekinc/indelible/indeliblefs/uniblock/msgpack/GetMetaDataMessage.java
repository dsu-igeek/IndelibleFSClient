...
@Message
public class GetMetaDataMessage<A> extends CASServerConnectionCommand<CASIDDataDescriptor, A, NetworkDataDescriptorMsgPack>
{
	String name;
	...
	public GetMetaDataMessage(CASServerFirehoseClient client, CASServerConnectionProxy connection,
			String name,
	...
	{
		return server.retrieveMetaData(clientInfo, getConnectionHandle(), name);
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kGetMetaData;
	}
