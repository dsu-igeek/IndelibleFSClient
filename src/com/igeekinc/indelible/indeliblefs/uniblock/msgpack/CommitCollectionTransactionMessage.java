...
@Message
public class CommitCollectionTransactionMessage<A> extends CASCollectionConnectionCommand<IndelibleFSTransaction, A, IndelibleFSTransactionMsgPack>
{
	public CommitCollectionTransactionMessage()
	{
		// for message pack
	}

	public CommitCollectionTransactionMessage(CASServerFirehoseClient client,
	...
	{
		return server.commitCollectionTransaction(clientInfo, getConnectionHandle(), getCollectionConnectionHandle());
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kCommitCollectionTransaction;
	}
}
