...
@Message
public class GetCollectionLastReplicatedEventIDMessage<A> extends CASCollectionConnectionCommand<Long, A, Long>
{
	public EntityIDMsgPack sourceServerID;
	public ObjectIDMsgPack collectionID;
	public GetCollectionLastReplicatedEventIDMessage()
	{
		// for message pack
	}
	
	public GetCollectionLastReplicatedEventIDMessage(CASServerFirehoseClient client, CASCollectionConnectionProxy connection,
			...
			AsyncCompletion<Long, A> callerCompletionHandler, A attachment)
	{
		...
		this.sourceServerID = new EntityIDMsgPack(sourceServerID);
	...
	{
		return server.getCollectionLastEventID(clientInfo, getConnectionHandle(), getCollectionConnectionHandle());
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kGetCollectionLastReplicatedEventID;
	}
}
