...
@Message
public class GetVersionsForSegmentIteratorMessage<A> extends CASCollectionConnectionCommand<IndelibleVersionIterator, A, VersionIteratorReply>
{
	public ObjectIDMsgPack id;
	public GetVersionsForSegmentIteratorMessage()
	{
		// for message pack
	}

	public GetVersionsForSegmentIteratorMessage(CASServerFirehoseClient client, CASCollectionConnectionProxy connection,
			ObjectID id,
	...
	{
		return CASServerCommand.kGetVersionsForSegmentIterator;
	}
}
