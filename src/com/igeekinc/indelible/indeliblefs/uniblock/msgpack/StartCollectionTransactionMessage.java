...
@Message
public class StartCollectionTransactionMessage<A> extends CASCollectionConnectionCommand<Void, A, Void>
{
	public StartCollectionTransactionMessage()
	{
		// for message pack
	}

	public StartCollectionTransactionMessage(CASServerFirehoseClient client,
	...
	{
		return server.startCollectionTransaction(clientInfo, getConnectionHandle(), getCollectionConnectionHandle());
	}
	...
	protected CASServerCommand getInitCASServerCommand()
	{
		...
		return CASServerCommand.kStartCollectionTransaction;
	}
}
