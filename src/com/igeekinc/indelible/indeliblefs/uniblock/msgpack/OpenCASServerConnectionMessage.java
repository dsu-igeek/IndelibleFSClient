...
@Message
public class OpenCASServerConnectionMessage<A> extends CASServerCommandMessage<CASServerConnectionHandle, A, CASServerConnectionHandle>
{
	public OpenCASServerConnectionMessage()
	{
		// for message pack
	}

	public OpenCASServerConnectionMessage(AsyncCompletion<CASServerConnectionHandle, A> callerCompletionHandler, A attachment)
	{
		super(callerCompletionHandler, attachment);
	}

	@Override
	protected CASServerConnectionHandle getValueFromResult(CASServerConnectionHandle result)
	{
		return result;
	}

	@Override
	public Class<CASServerConnectionHandle> getResultClass()
	{
		return CASServerConnectionHandle.class;
	}

	@Override
	public CommandResult execute(CASServerFirehoseServerIF server, CASServerClientInfoIF clientInfo) throws Exception
	{
		return server.openCASServerConnection(clientInfo);
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kOpenConnection;
	}
}
