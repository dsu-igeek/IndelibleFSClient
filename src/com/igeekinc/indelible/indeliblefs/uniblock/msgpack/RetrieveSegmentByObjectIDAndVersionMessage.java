...
@Message
public class RetrieveSegmentByObjectIDAndVersionMessage<A> extends CASCollectionConnectionCommand<DataVersionInfo, A, DataVersionInfoMsgPack>
{
	public ObjectIDMsgPack objectID;
	public IndelibleVersionMsgPack version;
	public int retrieveVersionFlags;
	
	public RetrieveSegmentByObjectIDAndVersionMessage()
	{
		// for message pack
	}

	public RetrieveSegmentByObjectIDAndVersionMessage(CASServerFirehoseClient client,
	...
	{
		return CASServerCommand.kRetrieveSegmentByObjectIDAndVersion;
	}
}
