...
@Message
public class GetCollectionEventsAfterIDIteratorMessage<A> extends CASCollectionConnectionCommand<IndelibleEventIterator, A, CASCollectionEventIteratorReply>
{
	long startingID;
	
	public GetCollectionEventsAfterIDIteratorMessage()
	{
		// for message pack
	}

	public GetCollectionEventsAfterIDIteratorMessage(CASServerFirehoseClient client, CASCollectionConnectionProxy connection,
			long startingID,
	...
	{
		return server.collectionEventsAfterIDIterator(clientInfo, getConnectionHandle(), getCollectionConnectionHandle(), startingID);
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kGetCollectionEventsAfterIDIterator;
	}
}
