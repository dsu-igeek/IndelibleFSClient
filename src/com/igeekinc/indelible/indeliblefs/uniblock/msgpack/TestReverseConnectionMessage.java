...
@Message
public class TestReverseConnectionMessage<A> extends CASServerConnectionCommand<Void, A, Void>
{
	public NetworkDataDescriptorMsgPack testNetworkDescriptor;
	public TestReverseConnectionMessage()
	{
		// for message pack
	}
	public TestReverseConnectionMessage(CASServerFirehoseClient client, CASServerConnectionProxy connection,
			NetworkDataDescriptor testNetworkDescriptor,
			AsyncCompletion<Void, A> callerCompletionHandler, A attachment)
	{
		super(client, connection, callerCompletionHandler, attachment);
		this.testNetworkDescriptor = new NetworkDataDescriptorMsgPack(testNetworkDescriptor);
	}
	@Override
	...
	{
		return server.testReverseConnection(clientInfo, getConnectionHandle(), testNetworkDescriptor.getNetworkDataDescriptor());
	}
	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kTestReverseConnection;
	}
}
