...
@Message
public class ListMetaDataNamesMessage<A> extends CASCollectionConnectionCommand<String [], A, ListMetaDataNamesReply>
{
	public ListMetaDataNamesMessage()
	{
		// for message pack
	}

	public ListMetaDataNamesMessage(CASServerFirehoseClient client, CASCollectionConnectionProxy connection,
	...
	@Override
	protected String [] getValueFromResult(ListMetaDataNamesReply result)
	{
		return result.getMetaDataNames();
	}

	@Override
	public Class<ListMetaDataNamesReply> getResultClass()
	{
		return ListMetaDataNamesReply.class;
	}

	@Override
	public CommandResult execute(CASServerFirehoseServerIF server, CASServerClientInfoIF clientInfo) throws Exception
	{
		return server.listMetaDataNames(clientInfo, getConnectionHandle(), getCollectionConnectionHandle());
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kListMetaDataNames;
	}
