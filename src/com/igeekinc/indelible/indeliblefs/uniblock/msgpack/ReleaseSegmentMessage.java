...
@Message
public class ReleaseSegmentMessage<A> extends CASCollectionConnectionCommand<Boolean, A, Boolean>
{
	public ObjectIDMsgPack segmentID;
	public ReleaseSegmentMessage()
	{
		// for message pack
	}

	public ReleaseSegmentMessage(CASServerFirehoseClient client,
			...
			AsyncCompletion<Boolean, A> callerCompletionHandler, A attachment)
	{
		...
		this.segmentID = new ObjectIDMsgPack(segmentID);
	}
	...
	{
		return server.releaseSegment(clientInfo, getConnectionHandle(), getCollectionConnectionHandle(), segmentID.getObjectID());
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kReleaseSegment;
	}
}
