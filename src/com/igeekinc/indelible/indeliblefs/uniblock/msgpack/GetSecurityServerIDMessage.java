...
@Message
public class GetSecurityServerIDMessage<A> extends CASServerCommandMessage<EntityID, A, EntityIDMsgPack>
{
	public GetSecurityServerIDMessage()
	{
		// for message pack
	}

	public GetSecurityServerIDMessage(AsyncCompletion<EntityID, A> callerCompletionHandler, A attachment)
	{
	...
	{
		return server.getSecurityServerID(clientInfo);
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kGetSecurityServerID;
	}
