...
@Message
public class ReleaseVersionedSegmentMessage<A> extends CASCollectionConnectionCommand<Boolean, A, Boolean>
{
	public ObjectIDMsgPack id;
	public IndelibleVersionMsgPack version;
	public ReleaseVersionedSegmentMessage()
	{
		// for message pack
	}

	public ReleaseVersionedSegmentMessage(CASServerFirehoseClient client,
			CASCollectionConnectionProxy collectionConnection,
			ObjectID id, IndelibleVersion version,
	...
	{
		return server.releaseVersionedSegment(clientInfo, getConnectionHandle(), getCollectionConnectionHandle(), id.getObjectID(), version.getIndelibleVersion());
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kReleaseVersionedSegment;
	}
}
