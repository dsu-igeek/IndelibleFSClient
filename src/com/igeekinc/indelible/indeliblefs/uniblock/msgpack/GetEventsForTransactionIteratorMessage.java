...
@Message
public class GetEventsForTransactionIteratorMessage<A> extends CASCollectionConnectionCommand<IndelibleEventIterator, A, CASCollectionEventIteratorReply>
{
	IndelibleFSTransactionMsgPack transaction;
	
	public GetEventsForTransactionIteratorMessage()
	{
		// for message pack
	}

	public GetEventsForTransactionIteratorMessage(CASServerFirehoseClient client,
			...
			AsyncCompletion<IndelibleEventIterator, A> callerCompletionHandler, A attachment)
	{
		...
		this.transaction = new IndelibleFSTransactionMsgPack(transaction);
	}
	...
	{
		return server.getEventsForTransaction(clientInfo, getConnectionHandle(), getCollectionConnectionHandle(), transaction.getTransaction());
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kGetEventsForTransactionIterator;
	}
}
