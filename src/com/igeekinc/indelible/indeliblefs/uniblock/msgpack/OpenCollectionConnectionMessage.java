...
@Message
public class OpenCollectionConnectionMessage<A> extends CASServerConnectionCommand<CASCollectionConnectionHandle, A, CASCollectionConnectionHandle>
{
	public ObjectIDMsgPack collectionID;
	
	public OpenCollectionConnectionMessage()
	{
		// for message pack
	}

	public OpenCollectionConnectionMessage(CASServerFirehoseClient client, CASServerConnectionProxy connection,
	...
	{
		return server.openCollectionConnection(clientInfo, getConnectionHandle(), getCollectionID());
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kOpenCollectionConnection;
	}
