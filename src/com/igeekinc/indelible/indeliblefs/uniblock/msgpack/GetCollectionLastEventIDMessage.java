...
@Message
public class GetCollectionLastEventIDMessage<A> extends CASCollectionConnectionCommand<Long, A, Long>
{
	public GetCollectionLastEventIDMessage()
	{
		// for message pack
	}
	
	public GetCollectionLastEventIDMessage(CASServerFirehoseClient client, CASCollectionConnectionProxy connection,
	...
	{
		return CASServerCommand.kGetCollectionLastEventID;
	}
}
