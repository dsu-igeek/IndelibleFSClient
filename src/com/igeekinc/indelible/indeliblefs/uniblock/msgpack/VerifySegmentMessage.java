...
@Message
public class VerifySegmentMessage<A> extends CASCollectionConnectionCommand<Boolean, A, Boolean>
{
	public ObjectIDMsgPack objectID;
	public IndelibleVersionMsgPack version;
	public int retrieveVersionFlags;
	
	public VerifySegmentMessage()
	{
		// for message pack
	}

	public VerifySegmentMessage(CASServerFirehoseClient client,
	...
	{
		return server.verifySegment(clientInfo, getConnectionHandle(), getCollectionConnectionHandle(), objectID.getObjectID(), version.getIndelibleVersion(),
	...
	{
		return CASServerCommand.kVerifySegment;
	}
}
