...
@Message
public class StoreVersionedSegmentMessage<A> extends CASCollectionConnectionCommand<Void, A, Void>
{
	public ObjectIDMsgPack id;
	public NetworkDataDescriptorMsgPack dataDescriptor;
	public StoreVersionedSegmentMessage()
	{
		// for message pack
	}

	public StoreVersionedSegmentMessage(CASServerFirehoseClient client,
	...
	{
		return server.storeVersionedSegment(clientInfo, getConnectionHandle(), getCollectionConnectionHandle(), id.getObjectID(), dataDescriptor.getNetworkDataDescriptor());
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kStoreVersionedSegment;
	}
}
