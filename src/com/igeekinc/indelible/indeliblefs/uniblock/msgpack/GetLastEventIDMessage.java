...
@Message
public class GetLastEventIDMessage<A> extends CASServerConnectionCommand<Long, A, Long>
{
	public GetLastEventIDMessage()
	{
		// for message pack
	}

	public GetLastEventIDMessage(CASServerFirehoseClient client, CASServerConnectionProxy connection,
	...
	{
		return server.getLastEventID(clientInfo, getConnectionHandle());
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kGetLastEventID;
	}
}
