...
@Message
public class CloseMessage<A> extends CASServerConnectionCommand<Void, A, Void>
{
	...
	public CloseMessage(CASServerFirehoseClient client, CASServerConnectionProxy connection,
	...
	{
		return server.closeCASServerConnection(clientInfo, getConnectionHandle());
	}

	@Override
	protected CASServerCommand getInitCASServerCommand()
	{
		return CASServerCommand.kClose;
	}
}
