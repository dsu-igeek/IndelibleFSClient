...
public class IndelibleVersionIteratorHandle implements org.msgpack.MessagePackable
{
	private long iteratorHandle;
	
	public IndelibleVersionIteratorHandle()
	{
		// for message pack
	}
	
	public IndelibleVersionIteratorHandle(long iteratorHandle)
	{
	...
	public boolean equals(Object obj)
	{
		...
		if (getClass() != obj.getClass())
			return false;
		IndelibleVersionIteratorHandle other = (IndelibleVersionIteratorHandle) obj;
