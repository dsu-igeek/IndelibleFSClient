...
import com.igeekinc.indelible.indeliblefs.firehose.IndelibleFSSymbolicLinkHandle;

@Message
public class CreateSymlinkInfoMsgPack
{
    private IndelibleFSObjectHandleMsgPack directoryNode;
    private IndelibleFSObjectHandleMsgPack createNode;
	public CreateSymlinkInfoMsgPack()
	{
		// for message pack
	}

	public CreateSymlinkInfoMsgPack(IndelibleFSDirectoryHandle directoryNode, IndelibleFSSymbolicLinkHandle createNode)
	{
	...
	public IndelibleFSSymbolicLinkHandle getCreateNode()
	{
		return (IndelibleFSSymbolicLinkHandle) createNode.getObjectHandle();
	}
}
