...
@Message
public class ListDirectoryReply
{
	public int numChildren;
	public NetworkDataDescriptorMsgPack dataDescriptor;
	public ListDirectoryReply()
	{
		// for message pack
	}

	public ListDirectoryReply(int numChildren, NetworkDataDescriptor dataDescriptor)
	{
	...
	public NetworkDataDescriptor getDataDescriptor()
	{
		return dataDescriptor.getNetworkDataDescriptor();
	}
}
