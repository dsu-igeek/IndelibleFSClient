...
@Message
public class GetSegmentIDsMessage<A> extends
		IndelibleFSForkCommandMessage<CASIdentifier [], A, GetSegmentIDsReply>
{

	public GetSegmentIDsMessage()
	{
		// for message pack
	}

	public GetSegmentIDsMessage(IndelibleFSFirehoseClient client, 
			IndelibleFSServerConnectionProxy connection,
			IndelibleFSForkHandle forkHandle,
			AsyncCompletion<CASIdentifier [], A> callerCompletionHandler, A attachment)
	{
		super(client, connection, forkHandle, callerCompletionHandler, attachment);
	}

	@Override
	protected CASIdentifier [] getValueFromResult(GetSegmentIDsReply result)
	{
		return result.getSegmentIDs();
	}

	@Override
	public Class<GetSegmentIDsReply> getResultClass()
	{
		return GetSegmentIDsReply.class;
	}
	...
	{
		return server.getSegmentIDs(clientInfo, getConnectionHandle(), getForkHandle());
	}

	@Override
	protected IndelibleFSServerCommand getInitServerCommand()
	{
		return IndelibleFSServerCommand.kGetSegmentIDs;
	}
}
