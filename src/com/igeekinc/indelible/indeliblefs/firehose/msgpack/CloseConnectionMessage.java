...
@Message
public class CloseConnectionMessage<A> extends
		IndelibleFSCommandMessage<Void, A, Void>
{
	...
	public CloseConnectionMessage(IndelibleFSServerConnectionHandle connection,
	...
	public IndelibleFSServerConnectionHandle getConnection()
	{
		return connection;
	}
	...
	{
		return server.closeConnection(clientInfo, getConnection());
	}

	@Override
	protected IndelibleFSServerCommand getInitServerCommand()
	{
		return IndelibleFSServerCommand.kCloseConnection;
	}
