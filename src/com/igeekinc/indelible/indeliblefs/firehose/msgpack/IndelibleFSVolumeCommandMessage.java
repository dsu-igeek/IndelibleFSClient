...
@Message
public abstract class IndelibleFSVolumeCommandMessage<V, A, R> extends
		IndelibleFSConnectionCommandMessage<V, A, R>
{
	public IndelibleFSObjectHandleMsgPack volume;
	
	public IndelibleFSVolumeCommandMessage()
	{
		// for message pack
	}

	public IndelibleFSVolumeCommandMessage(IndelibleFSFirehoseClient client,
	...
	public IndelibleFSVolumeHandle getVolumeHandle()
	{
		return (IndelibleFSVolumeHandle) volume.getObjectHandle();
	}
}
