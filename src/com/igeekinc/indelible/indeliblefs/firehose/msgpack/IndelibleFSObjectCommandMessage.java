...
@Message
public abstract class IndelibleFSObjectCommandMessage<V, A, R> extends
		IndelibleFSConnectionCommandMessage<V, A, R>
{
	public IndelibleFSObjectHandleMsgPack objectHandle;
	public IndelibleFSObjectCommandMessage()
	{
		// for message pack
	}

	public IndelibleFSObjectCommandMessage(IndelibleFSFirehoseClient client, 
			...
			AsyncCompletion<V, A> callerCompletionHandler, A attachment)
	{
		...
		this.objectHandle = new IndelibleFSObjectHandleMsgPack(objectHandle);
	}
	
	public IndelibleFSObjectHandle getFileHandle()
	{
		return (IndelibleFSObjectHandle) objectHandle.getObjectHandle();
	}
}
