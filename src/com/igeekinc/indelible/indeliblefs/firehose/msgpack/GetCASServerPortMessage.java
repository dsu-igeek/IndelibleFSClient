...
@Message
public class GetCASServerPortMessage<A> extends IndelibleFSCommandMessage<Integer, A, Integer>
{
	public GetCASServerPortMessage()
	{
	}
	public GetCASServerPortMessage(AsyncCompletion<Integer, A>callerCompletionHandler, A callerAttachment)
	{
	...
	{
		return server.getCASServerPort(clientInfo);
	}
	@Override
	protected IndelibleFSServerCommand getInitServerCommand()
	{
		return IndelibleFSServerCommand.kGetCASServerPort;
	}
}
