...
@Message
public class TruncateMessage<A> extends
		IndelibleFSForkCommandMessage<Long, A, Long>
{
	long truncateLength;
	public TruncateMessage()
	{
		// for message pack
	}
	...
	{
		return server.truncate(clientInfo, getConnectionHandle(), getForkHandle(), truncateLength);
	}

	@Override
	protected IndelibleFSServerCommand getInitServerCommand()
	{
		return IndelibleFSServerCommand.kTruncate;
	}
