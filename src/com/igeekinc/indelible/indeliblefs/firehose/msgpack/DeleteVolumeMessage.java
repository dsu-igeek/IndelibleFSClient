...
@Message
public class DeleteVolumeMessage<A> extends IndelibleFSConnectionCommandMessage<Void, A, Void>
{
	public IndelibleFSObjectIDMsgPack deleteVolumeID;
	
	public DeleteVolumeMessage()
	{
		// For message pack
	}

	public DeleteVolumeMessage(IndelibleFSFirehoseClient client, 
			IndelibleFSServerConnectionProxy connection,
			IndelibleFSObjectID deleteVolumeID, 
			AsyncCompletion<Void, A> callerCompletionHandler, A attachment)
	{
		super(client, connection, callerCompletionHandler, attachment);
		this.deleteVolumeID = new IndelibleFSObjectIDMsgPack(deleteVolumeID);
	}
	...
	@Override
	public CommandResult execute(IndelibleFSFirehoseServerIF server, IndelibleFSClientInfoIF clientInfo) throws Exception
	{
		return server.deleteVolume(clientInfo, connectionHandle, deleteVolumeID);
	}

	@Override
	protected IndelibleFSServerCommand getInitServerCommand()
	{
		return IndelibleFSServerCommand.kDeleteVolume;
	}
}
