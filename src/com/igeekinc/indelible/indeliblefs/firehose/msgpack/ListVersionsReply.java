...
@Message
public class ListVersionsReply
{
	...
	public ListVersionsReply()
	{
		// for message pack
	}
	
	public ListVersionsReply(IndelibleVersionIteratorHandle handle, IndelibleVersion[] versions, boolean hasMore)
	{
		this.handle = handle;
