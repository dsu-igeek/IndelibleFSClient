...
@Message
public class GetCurrentVersionMessage<A>
		extends
		IndelibleFSObjectCommandMessage<IndelibleVersion, A, IndelibleVersionMsgPack>
{
	public GetCurrentVersionMessage()
	{
		// For message pack
	}

	public GetCurrentVersionMessage(IndelibleFSFirehoseClient client, 
	...
	@Override
	protected IndelibleVersion getValueFromResult(
			IndelibleVersionMsgPack result)
	{
	...
	{
		return server.getCurrentVersion(clientInfo, connectionHandle, objectHandle.getObjectHandle());
	}

	@Override
	protected IndelibleFSServerCommand getInitServerCommand()
	{
		return IndelibleFSServerCommand.kGetCurrentVersion;
	}
}
