		...
		IndelibleFSForkCommandMessage<Void, A, Void>
{
	...
	{
		return server.appendDataDescriptor(clientInfo, getConnectionHandle(), forkHandle, dataDescriptor.getNetworkDataDescriptor());
	}

	@Override
	protected IndelibleFSServerCommand getInitServerCommand()
	{
		return IndelibleFSServerCommand.kAppendDataDescriptor;
	}

	public String toString()
	{
		return "AppendDataDescriptorMessage length = "+dataDescriptor.getNetworkDataDescriptor().getLength()+" casID = "+dataDescriptor.getNetworkDataDescriptor().getCASIdentifier();
	}
}
