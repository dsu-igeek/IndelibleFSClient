...
@Message
public class GetVolumeNameMessage<A> extends
		IndelibleFSVolumeCommandMessage<String, A, String>
{

	public GetVolumeNameMessage()
	{
		super();
	...
	{
		return server.getVolumeName(clientInfo, getConnectionHandle(), getVolumeHandle());
	}

	@Override
	protected IndelibleFSServerCommand getInitServerCommand()
	{
		return IndelibleFSServerCommand.kGetVolumeName;
	}
}
