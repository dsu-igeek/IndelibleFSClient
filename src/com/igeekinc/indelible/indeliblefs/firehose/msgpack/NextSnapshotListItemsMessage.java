...
@Message
public class NextSnapshotListItemsMessage<A>
		extends
		IndelibleFSConnectionCommandMessage<NextSnapshotListItemsReply, A, NextSnapshotListItemsReply>
{
	IndelibleSnapshotIteratorHandle handle;
	public NextSnapshotListItemsMessage()
	{
		// for message pack
	}
	...
	public NextSnapshotListItemsMessage(
			...
			IndelibleSnapshotIteratorHandle handle,
			AsyncCompletion<NextSnapshotListItemsReply, A> callerCompletionHandler,
			A attachment)
	{
	...
	@Override
	protected NextSnapshotListItemsReply getValueFromResult(
			NextSnapshotListItemsReply result)
	{
		return result;
	}

	@Override
	public Class<NextSnapshotListItemsReply> getResultClass()
	{
		return NextSnapshotListItemsReply.class;
	}
	...
	{
		return server.nextSnapshotListItems(clientInfo, getConnectionHandle(), handle);
	}

	@Override
	protected IndelibleFSServerCommand getInitServerCommand()
	{
		return IndelibleFSServerCommand.kNextSnapshotListItems;
	}
