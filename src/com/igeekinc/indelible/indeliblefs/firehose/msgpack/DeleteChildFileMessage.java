...
@Message
public class DeleteChildFileMessage<A>
		extends
		IndelibleFSDirectoryCommandMessage<DeleteFileInfo, A, DeleteFileInfoMsgPack>
{
	public String name;
	
	public DeleteChildFileMessage()
	{
		// for message pack
	}

	public DeleteChildFileMessage(IndelibleFSFirehoseClient client, 
	...
	{
		return server.deleteChildFile(clientInfo, getConnectionHandle(), (IndelibleFSDirectoryHandle)directoryHandle.getObjectHandle(), name);
	}

	@Override
	protected IndelibleFSServerCommand getInitServerCommand()
	{
		return IndelibleFSServerCommand.kDeleteChildFile;
	}
