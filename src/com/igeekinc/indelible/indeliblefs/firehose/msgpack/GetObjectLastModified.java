...
@Message
public class GetObjectLastModified<A> extends
		IndelibleFSFileCommandMessage<Long, A, Long>
{
	public GetObjectLastModified()
	{
		// for message pack
	}

	public GetObjectLastModified(IndelibleFSFirehoseClient client, 
	...
	{
		return server.lastModified(clientInfo, getConnectionHandle(), getFileHandle());
	}

	@Override
	protected IndelibleFSServerCommand getInitServerCommand()
	{
		return IndelibleFSServerCommand.kGetLastModified;
	}
