...
public class DeleteFileInfoRemote implements Serializable
{
	private static final long	serialVersionUID	= 6665869779452779014L;
	private IndelibleDirectoryNodeRemote directoryNode;
    boolean deleteSucceeded;

    public DeleteFileInfoRemote(IndelibleDirectoryNodeRemote directoryNode, boolean deleteSucceeded)
    {
